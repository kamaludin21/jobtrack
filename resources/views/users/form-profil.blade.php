                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-sm" name="gaji" placeholder="nominal" required>
                                            </div>
                                        </div>
                                        <div class="col">
                                          <div class="form-group">
                                              ...
                                              <div class="">
                                                <div class="form-check form-check-inline">
                                                  <input class="form-check-input" type="radio" name="status" id="yes" value="YES">
                              ...
                              @else
                                ...
                                <form method="POST" action="{{ url('user/profil/store', [$profil->id]) }}" class="px-1">
                                  ...
                                  @csrf
                                    <div class="form-group">
                                        <label for="desc">Deskripsi tentang diri anda</label>
                                        <textarea class="form-control form-control-sm" name="description" rows="5" placeholder="Promosikan tentang diri anda dengan singkat dan jelas">{{ $profil->description }}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                          @php($tempat = explode(',', $profil->ttl))
                                            <div class="form-group">
                                                <label for="">Tempat lahir</label>
                                                <input type="text" class="form-control form-control-sm" name="tempat" placeholder="Tempat lahir" value="{{ $tempat[0] }}">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">Tanggal lahir</label>
                                                <input type="date" class="form-control form-control-sm" name="tgl" value="{{ trim($tempat[1]) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                  <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="kelamin" id="laki-laki" value="Laki-laki" {{ $profil->kelamin == 'Laki-laki' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="inlineRadio1">Laki-laki</label>
                                                  </div>
                                                  <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="kelamin" id="perempuan" value="Perempuan"  {{ $profil->kelamin == 'Perempuan' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <label for="">Alamat</label>
                                        <input type="text" name="alamat" class="form-control form-control-sm" placeholder="Alamat tempat tinggal" value="{{ $profil->alamat }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="">Email</label>
                                        <input type="text" name="email" class="form-control form-control-sm" placeholder="Email aktif" value="{{ $profil->email }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="">No. Telp</label>
                                        <input type="text" name="telp" class="form-control form-control-sm" placeholder="Nomor telpon aktif" value="{{ $profil->telp }}">
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col">
                                          <label for="social1">Facebook link</label>
                                          <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="social1" class="form-control form-control-sm" id="social1" aria-describedby="basic-addon3" value="{{ $profil->social1 }}">
                                          </div>
                                        </div>
                                        <div class="col">
                                          <label for="social2">Linkedin link</label>
                                          <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="social2" class="form-control form-control-sm" id="social2" aria-describedby="basic-addon3" value="{{ $profil->social2 }}">
                                          </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="">Nominal gaji yang diharapkan</label>
                                                <input type="text" class="form-control form-control-sm" name="gaji" placeholder="nominal" value="{{ $profil->gaji }}">
                                            </div>
                                        </div>
                                        <div class="col">
                                          <div class="form-group">
                                              ...
                                              {{-- <select class="form-control form-control-sm" name="status">
                                                <option value="YES" {{ $profil->status == 'YES' ? 'selected' : '' }}>Ya</option>
                                                <option value="NO" {{ $profil->status == 'NO' ? 'selected' : '' }}>Tidak</option>
                                              </select> --}}
                                              <div class="">
                                                <div class="form-check form-check-inline">
                                                  <input class="form-check-input" type="radio" name="status" id="laki-laki" value="YES" {{ $profil->status == 'YES' ? 'checked' : '' }}>
                                                  <label class="form-check-label" for="inlineRadio1">Ya</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                  <input class="form-check-input" type="radio" name="status" id="perempuan" value="NO"  {{ $profil->status == 'NO' ? 'checked' : '' }}>
